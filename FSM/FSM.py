...
from policy.wbt_dance.WbtDance import WbtDance
...
class FSM:
    def __init__(self, state_cmd:StateAndCmd, policy_output:PolicyOutput):
        ...
        self.wbt_dance_policy = WbtDance(state_cmd, policy_output)
    ...
    def get_next_policy(self, policy_name:FSMStateName):
        ...
        elif((policy_name == FSMStateName.SKILL_WBT_DANCE)):
            self.cur_policy = self.wbt_dance_policy
        else:
            pass
